...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Conectarea la serverul bazei de date se face folosind functia de conectare <b> mysqli_connect</b>
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Functia <b> mysql_connect</b> a fost inlocuita in ultimele versiuni cu <b> mysqli_connect</b> functie careia i se transmite 
numele bazei de date la care se face conectarea fara a fi necesara conectarea in prealabil la aceasta.
<br>&nbsp;&nbsp;&nbsp;&nbsp;Sintaxa acestei functii este urmatoarea:
<br><br><!------------------------------------------------------------------->
<table width="100%" border=1><tr><td bgcolor="WhiteSmoke">
<font size="3" color="DarkBlue"><pre>
...
<!------------------------------------------------------------------->
<br>&nbsp;&nbsp;&nbsp;&nbsp;Scriptul "con_mysqli.php" care realizeaza conectarea la serverul bazei de date si selecteaza baza de date "cons_el" devine:

<!------------------------------------------------------------------->
<br><br><textarea width="100%" height="400px" style="width:100%;height:250px" name="code" wrap="logical" rows="12" cols="42">
&lt?php # Script 13.4 - con_mysqli.php
// Acest script realizeaza conectarea la baza de date "cons_el"
// Setarea informatiilor necesare conectarii la baza de date.
DEFINE ('DB_USER', 'student');
DEFINE ('DB_PASSWORD', 'psw');
...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Sa presupunem ca vrem sa creem o tabela "electr" in cadrul schemei "cons_el", cu urmatoarea structura:
<ul>
<li>&nbsp;&nbsp;&nbsp;&nbsp; id_el int(10) unsigned NOT NULL,
<li>&nbsp;&nbsp;&nbsp;&nbsp; val decimal(14,2) NOT NULL,
<li>&nbsp;&nbsp;&nbsp;&nbsp; min decimal(14,2) NOT NULL,
<li>&nbsp;&nbsp;&nbsp;&nbsp; max decimal(14,2) NOT NULL,
<li>&nbsp;&nbsp;&nbsp;&nbsp; um varchar(10) NOT NULL,
<li>&nbsp;&nbsp;&nbsp;&nbsp; PRIMARY KEY  (`id_el`)
</ul>
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Urmatoarele fraze SQL de exemplu genereaza tabela "electr" si o initializeaza cu doua inregistrari.
<br><br><!------------------------------------------------------------------->
...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Vom scrie in continuare o aplicatie server in php, care sa afiseze valorile tuturor inregistrarilor, din tabela "electr" 
din baza de date "cons_el", unde se va folosi functia de conectare <b> mysql_connect</b>


<br><br><!------------------------------------------------------------------->
<textarea style="width:100%;height:350px" name="code" wrap="logical" rows="12" cols="42">
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;Dupa cum se observa, fraza de interogare a bazei de date este trimisa ca parametru functiei <b> @mysql_query </b>. 
Functia <b> @mysql_query </b> returneaza raspunsul bazei de date sub forma unui tablou. Variabila $rezult este defapt un tablou care are atatea linii 
cate inregistrari s-au gasit in baza de date.
<br>&nbsp;&nbsp;&nbsp;&nbsp;Extragerea unei linii din acest tablou se face cu functia <b> mysql_fetch_array() </b> . Variabila $row este deci un vector 
care contine atatea elemente cate campuri au fost selectate din baza de date.
<br>&nbsp;&nbsp;&nbsp;&nbsp;Extragerea unei valori corespunzatoare unui camp se face desigur utilizand un index sau denumirea asociata. Astfel 
pentru a obtine de exemplu valoarea id_el vom folosi $row[0] sau  $row['id_el'], identic pentru a obtine valoarea min vom folosi: $row[3] sau  $row['min'] 

<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Vom relua aplicatia care afiseaza valorile tuturor inregistrarilor, din tabela "electr" 
din baza de date "cons_el", dar se va folosi functia de conectare <b> mysqli_connect</b>


<br><br><!------------------------------------------------------------------->
<textarea style="width:100%;height:380px" name="code" wrap="logical" rows="14" cols="42">
&lt?php # Script afisare.php
...
<!------------------------------------------------------------------->
<br>&nbsp;&nbsp;&nbsp;&nbsp;Ne propunem sa realizam in continuare, o aplicatie client server cu acces la o baza de date, aplicatie care gestioneaza 
aparatele electrice.
...
<!------------------------------------------------------------------->
<br><br><textarea width="100%" height="400px" style="width:100%;height:2550px" name="code" wrap="logical" rows="12" cols="42">
...
<!------------------------------------------------------------------->
<br><br><textarea width="100%" height="400px" style="width:100%;height:1820px" name="code" wrap="logical" rows="12" cols="42">
...
<br><br><!------------------------------------------------------------------->
<textarea width="100%" height="400px" style="width:100%;height:1845px" name="code" wrap="logical" rows="12" cols="42">
...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Sa presupunem ca avem un sistem de achizitie date realizat pe baza unui sistem de dezvoltare PIC
<br><br><center>&nbsp;&nbsp;&nbsp;&nbsp; <a href="./sch_pic/sch_dezv.pdf"> Vezi schema sistemului de dezvoltare bazat pe controlerul PIC </a></center> 
<br>&nbsp;&nbsp;&nbsp;&nbsp;Sistemul de achizitie dispune de 5 intrari analogice 4 digitale si 8 iesiri digitale, conectate astfel:
<center> <img src="./sch_pic/achiz_pic.jpg"></center>
<ul>
...
&nbsp;&nbsp;&nbsp;&nbsp; Vom realiza in continuare o aplicatie de achizitie si monitorizare date care utilizeaza sistemul de achizitie date 
descris mai sus. Aplicatia de achizitie va fi realizata in Visual C++ 2008 iar aplicatia pentru afisare in pagini WEB  va fi realizata in PhP. 
Datele vor fi stocate intr-o baza de date de tip MySQL. Sa presupunem ca achizitionam 5 parametri analogici cu comanda AA apoi ii pastram intr-o 
tabela numita <b> t_points </b>, tabela care face parte din baza de tate de tip MySQL <b> cons_el </b>
...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Vom crea un proiect Windows Forms Application intitulat <font size="3" color="red" > "Rs_232_SQL" </font>, pe care plasam :
<ul>
...
<!------------------------------------------------------------------->
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;Aplicatia poate fi descarcata si direct:<a href="Rs_232_SQL.exe"> Descarcati aplicatia Rs_232_SQL.exe </a>
<br>&nbsp;&nbsp;&nbsp;&nbsp;In cazul in care aplicatia nu functioneaza ar putea fi cauzata de instalarea incorecta a
driver-ului MySQL. Urmatoarea aplicatie testeaza achizitia de date fara conectare la baza de date.
<a href="Rs_232_v4.exe"> Descarcati aplicatia Rs_232_v4.exe </a>
<br>&nbsp;&nbsp;&nbsp;&nbsp;In lipsa sistemului de achizitie date, am putea realiza o aplicatie in php care sa modifice datele in baza de date:
<!------------------------------------------------------------------->
